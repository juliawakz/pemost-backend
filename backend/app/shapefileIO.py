...
def import_farms(shapefile):
    ...
    for i in range(layer.GetFeatureCount()):
        ...
        fields["farm_boundary"] = geometry
        fields["farm_name"] = f"{first_name}-{last_name}-{geometry.wkt[-8:-4]}"

        county, created = County.objects.get_or_create(name="Machakos", county_num=16)
