...
class CropVariety(BaseModel):
    ...
    min_maturity_days = models.IntegerField(
        default=0, validators=[MinValueValidator(0)])
    max_maturity_days = models.IntegerField(
        default=0, validators=[MinValueValidator(0)])

    min_yield = models.FloatField(
        default=0, validators=[MinValueValidator(0)])
    max_yield = models.FloatField(
        default=0, validators=[MinValueValidator(0)])

    climate = models.CharField(max_length=100)

    min_rainfall_mm = models.FloatField(
        default=0, validators=[MinValueValidator(0)])
    max_rainfall_mm = models.FloatField(
        default=0, validators=[MinValueValidator(0)])

    min_altitude_masl = models.FloatField(
        default=0, validators=[MinValueValidator(0)])
    max_altitude_masl = models.FloatField(
        default=0, validators=[MinValueValidator(0)])

    row_spacing_cm = models.IntegerField(
        default=0, validators=[MinValueValidator(0)])
    plant_spacing_hill = models.IntegerField(
        default=0, blank=True, validators=[MinValueValidator(0)])

    fertilizer_dap_kg = models.IntegerField(
        default=0, blank=True, validators=[MinValueValidator(0)])
    fertilizer_can_kg = models.IntegerField(
        default=0, blank=True, validators=[MinValueValidator(0)])
    fertilizer_17_17_17_kg = models.IntegerField(
        default=0, blank=True, validators=[MinValueValidator(0)])
    ...
    seed_rate_g_per_acre = models.IntegerField(
        default=0, blank=True, validators=[MinValueValidator(0)])
